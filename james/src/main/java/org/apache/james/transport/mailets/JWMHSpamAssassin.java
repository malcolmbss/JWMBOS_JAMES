...
public class JWMHSpamAssassin extends JamesSpamAssassin {
    ...
    @Override public void service(Mail mail)
    {
       ...
       logger.debug("Exit JWMHSpamAssassin.service() from:  -- " + mail.getMaybeSender().asString() + " - " + (String)mail.getAttribute( FLAG_MAIL_ATTRIBUTE_NAME ) + " " + (String)mail.getAttribute( STATUS_MAIL_ATTRIBUTE_NAME ));
    }
}
